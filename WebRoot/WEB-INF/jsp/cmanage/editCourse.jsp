...
<form action="editCourseSubmit.action" method="post">
	<div>课程编号:<input type="text" name="course_id" value="${course_view.course_id}"/></div>
	<div>课程名称：<input type="text" name="course_name" value="${course_view.course_name }"/></div>
	<div>学分：<input type="text" name="course_credit" value="${course_view.course_credit }"></div>
	<div>学&#12288;&#12288;院：
...
　					</c:otherwise>  	
	...
	<div>开课时间：<input type="text" name="course_time" value="${course_view.course_time}"/></div><br/>
	<div>开课地点：<input type="text" name="course_classroom" value="${course_view.course_classroom}"/></div><br/>
	<div>课程人数：<input type="text" name="course_stu_num" value="${course_view.course_stu_num}"/></div><br/>
	<div>已选课人数：<input type="text" name="course_selection" value="${course_view.course_selection}"></div>
	
	<div>
	<input type="submit" value="提交" width="300px" class="button"  ></div>
</form>		
</div>
<script>
